<?php ob_start(); ?>
<!--Receives  user_id and key generated to create the new password-->
<!--Displays a form to input new password-->
...
?>
        ...
        <script src="js/bootstrap.min.js"></script>
            <!--Script for Ajax Call to store and reset password reset_User_Password.php which processes form data-->
            <script>
             //When form submitted
            $("#passwordreset").submit(function(event){ 
                ...
                //send them to user_Signup.php using AJAX
                $.ajax({
                    ...
                    error: function(){
                        $("#resultmessage").html("<div class='alert alert-danger'>There was an error Please try again later.</div>");
